...
object "Greeter_32" {
    code {
        /// @src 0:96:569  "contract Greeter {..."
        mstore(64, memoryguard(128))
        if callvalue() { revert_error_ca66f745a3ce8ff40e2ccaf1ad45db7774001b90d25810abd9040049be7bf4bb() }

        let _1 := copy_arguments_for_constructor_13_object_Greeter_32()
        constructor_Greeter_32(_1)

        let _2 := allocate_unbounded()
        codecopy(_2, dataoffset("Greeter_32_deployed"), datasize("Greeter_32_deployed"))

        return(_2, datasize("Greeter_32_deployed"))
        ...
        function copy_arguments_for_constructor_13_object_Greeter_32() -> ret_param_0 {
        ...
        /// @ast-id 13
        /// @src 0:149:296  "constructor(string memory _greeting) {..."
        function constructor_Greeter_32(var__greeting_5_mpos) {

            /// @src 0:149:296  "constructor(string memory _greeting) {..."

            /// @src 0:280:289  "_greeting"
            let _3_mpos := var__greeting_5_mpos
            let expr_9_mpos := _3_mpos
            /// @src 0:269:289  "greeting = _greeting"
    ...
    object "Greeter_32_deployed" {
        code {
            ...
            /// @ast-id 21
            /// @src 0:302:387  "function greet() public view returns (string memory) {..."
            function fun_greet_21() -> var__16_mpos {
                /// @src 0:340:353  "string memory"
                let zero_t_string_memory_ptr_1_mpos := zero_value_for_split_t_string_memory_ptr()
                var__16_mpos := zero_t_string_memory_ptr_1_mpos

                /// @src 0:372:380  "greeting"
                let _2_slot := 0x00
                let expr_18_slot := _2_slot
                /// @src 0:365:380  "return greeting"
                var__16_mpos := convert_array_t_string_storage_to_t_string_memory_ptr(expr_18_slot)
                leave
            ...
            /// @ast-id 31
            /// @src 0:393:567  "function setGreeting(string memory _greeting) public {..."
            function fun_setGreeting_31(var__greeting_23_mpos) {

                /// @src 0:551:560  "_greeting"
                let _3_mpos := var__greeting_23_mpos
                let expr_27_mpos := _3_mpos
                /// @src 0:540:560  "greeting = _greeting"
                update_storage_value_offset_0t_string_memory_ptr_to_t_string_storage(0x00, expr_27_mpos)
                let _4_slot := 0x00
                let expr_28_slot := _4_slot
        ...
        data ".metadata" hex"a3646970667358221220bf39e7806da17866099db074eec6c4746f768f7a713baa0958e73300a87759f66c6578706572696d656e74616cf564736f6c634300080b0041"
    }
